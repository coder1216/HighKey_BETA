    ...
    let {
      ...
      return (
       ...
       <View style={styles.container}>
           ...
           {/*<Navigator*/}
               {/*initialRoute={{component: startGame}}*/}
               {/*selected={this.state.selectItem == 'startGame'}*/}
               {/*onpress={()=>{this.setState({selectedItem :'startGame'})}}*/}
           {/*>*/}
               {/*<startGame />*/}
           {/*</Navigator>*/}
           ...
           <View  >
               ...
               >
                   ...
                   <View style = { position = "absolute"} >
                       <TouchableHighlight style = { styles.crossButton } onPress={() => {
                           this.setModalVisible(!this.state.modalVisible)
                       }}>
                           <Image  style = {{widht:30, height:30}} source={require('../../images/pin.png')}/>
                       </TouchableHighlight>
