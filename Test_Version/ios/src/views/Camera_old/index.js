...
import { View, StatusBar, StyleSheet, AsyncStorage, Keyboard, Easing, FlatList, ScrollView, InteractionManager, Dimensions, TouchableOpacity, } from 'react-native';
  ...
  render() {
      ...
      return (
       ...
       <View style={styles.container}>
            <NavigationBar
              centerComponent={<Title>Camera</Title>}
            />
            <Recorder 
              ...
              >
                <TouchableOpacity onPress={this.preview} style={{height: 300, justifyContent: 'flex-end'}}>
                  <Text>Preview</Text>
                </TouchableOpacity>
              </Recorder>
