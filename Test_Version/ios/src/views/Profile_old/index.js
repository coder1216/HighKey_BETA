...
import { View, StatusBar, StyleSheet, AsyncStorage, Keyboard, Easing, FlatList, Dimensions, ScrollView, InteractionManager,  } from 'react-native';
...
//UI
import { Title, TextInput, Button, Text, Caption, View as ViewShoutem, NavigationBar, Lightbox, Image, Card, Divider, Subtitle, Tile, TouchableOpacity, Spinner, ListView, GridRow} from '@shoutem/ui';
  ...
  renderRow(rowData, sectionId, index) {
    ...
    return (
        <TouchableOpacity key={id}>
          <Lightbox swipeToDismiss={true} renderContent={this.renderImage} activeProps={{style: {width: Dimensions.get('window').width, height: Dimensions.get('window').height}}}>  
            <Image
              styleName="small"
            ...
            >
              <Tile>
                ...
                <View styleName="horizontal">
                  <Caption styleName="collapsible" numberOfLines={2}>245 views</Caption>
                </View>
              </Tile>
            </Image>
          </Lightbox>
