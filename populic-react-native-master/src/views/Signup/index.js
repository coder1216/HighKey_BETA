  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View>
          <Title styleName="h-center bold bright" style={{ marginTop: 80 }}>
            SIGNUP
          </Title>
          ...
          >
            <Button
              ...
              onPress={() => this.handleChangeSlide(1)}
            >
              <Text>Sign up</Text>
            </Button>
          </ViewShoutem>
        ...
        <View style={styles.termsContainer}>
          <Caption styleName="h-center">By registering, you accept our</Caption>
